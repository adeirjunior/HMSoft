    ...
    <div className="py-12 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div className="sm:col-span-2">
                ...
                <div className="flex flex-col mx-auto mt-6 space-y-3 md:space-y-0 md:flex-row items-center">
                    <Input variant="bordered" id="email" type="text" className="px-4 py-2" placeholder="Email Address" />
